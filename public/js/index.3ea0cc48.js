var e = Object.defineProperty,
  ...
  i = (r, o, t) =>
    o in r
      ...
      : (r[o] = t),
  n = (e, r) => {
    for (var o in r || (r = {})) l.call(r, o) && i(e, o, r[o]);
...
!(function (e) {
  ...
  s.classList.add("triple-slider-next"), e.appendChild(s);
  const i = s.querySelectorAll(".swiper-slide")[0];
  s.querySelector(".swiper-wrapper").appendChild(i),
    r.classList.add("triple-slider-main");
  const u = { modules: [p, a], speed: 600, loop: !0, parallax: !0, autoplay: { delay: 5000, disableOnInteraction: false } };
  let f;
  const y = new d(
      o,
      c(n({}, u), {
