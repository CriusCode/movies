...
<head>
    ...
    <script type="module" crossorigin src="js/index.3ea0cc48.js"></script>
    <link rel="modulepreload" href="js/vendor.3d228fec.js">
    <link rel="stylesheet" href="css/index.000c16e0.css">
...
<body>
    <nav id="navbar" class="navbar navbar-expand-lg bg-body-primary mb-4 data-bs-theme='dark'" style="background-color: #252525">
        <div class="container">
            <a class="navbar-brand text-white" href="<?php echo $router->generate('home'); ?>"><img src="images/assets/logoterrorama.png" alt="Logo de Terrorama" style="width:100px" /></a>
